...
const APP_NAME = 'iCloud Find My';
const PROTOCOL = 'icloud-findmy';
const ICLOUD_URL = 'https://www.icloud.com/find';
...
function createTray() {
  ...
  tray.setContextMenu(Menu.buildFromTemplate([
    ...
    { type: 'separator' },
    { label: 'Find Devices', click: () => { if (!mainWindow) createWindow(); mainWindow.show(); mainWindow.loadURL('https://www.icloud.com/find'); } },
    { type: 'separator' },
...
function setupJumpList() {
  app.setJumpList([
    { type: 'tasks', items: [
      { type: 'task', title: 'Find Devices', description: 'Locate your devices', program: process.execPath, args: `${PROTOCOL}://devices`, iconPath: process.execPath, iconIndex: 0 }
    ]}
  ]);
}
